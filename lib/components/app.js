...
var languageOptions = [{ title: 'Java',
  short: 'Java',
  value: 'java' }, { title: 'Python',
  short: 'Python',
  value: 'python' }, { title: 'JavaScript',
  short: 'JS',
  value: 'javascript' }, { title: 'C#',
  short: 'csp',
  value: 'csp' }, { title: 'PHP',
  short: 'php',
  value: 'php' }];
...
var App = function (_React$PureComponent) {
  ...
  _createClass(App, [{
    ...
    key: 'navigationItemClicked',
    value: function navigationItemClicked(activeSection) {
      var _this3 = this;
    ...
    key: 'toggleColumnMode',
    value: function toggleColumnMode() {
      this.setState({
